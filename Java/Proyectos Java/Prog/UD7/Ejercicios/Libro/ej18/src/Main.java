 ...
 * El contenido del main es idéntico al ejercicio anterior.<br>
 * Salida</p>
 *
 * <pre>
...
public class Main {
    public static void main(String[] args) {
        ...
        miCarrito.agrega(new Elemento("Tarjeta SD 64Gb", 19.95f, 2));
        ...
        miCarrito.agrega(new Elemento("Tarjeta SD 64Gb", 19.95f, 1));
        System.out.println(miCarrito);
