...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        factura = hacerFactura(productos, compra);
    ...
    public static String hacerFactura(HashMap<String, Float> productos, HashMap<String, Integer> compra){
        String ret = "";
        float total = 0, porProducto;
