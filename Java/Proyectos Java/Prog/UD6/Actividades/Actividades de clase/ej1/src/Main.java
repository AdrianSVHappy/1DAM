 ...
 *
 * <pre>Nos piden hacer una un programa que gestione empleados.
 * Los empleados se definen por tener:
 *  Nombre
 *  Edad
 *  Salario
 * También tendremos una constante llamada PLUS, que tendrá un valor de
 * 300€.
 ...
 * No se podrán crear objetos del tipo Empleado (la clase padre) pero si de sus
 * hijas.
 * Las clases tendrán un método llamado “plus”, que según en cada clase tendrá
 * una implementación distinta. Este plus básicamente aumenta el salario del
 * empleado.
 *  En comercial, si tiene más de 30 años y cobra una comisión de más de 200
 * euros, se le aplicara el plus.
 *  En repartidor, si tiene menos de 25 y reparte en la “zona 3”, este recibirá el
 * plus.
 ...
 * plus para comprobar que funciona. </pre>
 *
...
public class Main {
    public static void main(String[] args) {
        ...
        emp [0] = new Repartidor("Paco", 33, 5, "zona 3");
        emp [1] = new Repartidor("Juan", 20, 52, "zona 3");
        emp [2] = new Comercial("Luisa", 15, 1000, 1500);
        emp [3] = new Comercial("Maria", 33, 5, 1500);
