...
/* 4) Escribe un programa que, al recibir como datos dos arrays bidimensionales
    A[M][N] y B[N][P], calcule el producto de dichos arrays y almacene el resultado
    en el array bidimensional C[M][P] utilizando aritmética de punteros.
    Datos: A[M][N], B[N][P] (arrays bidimensionales reales de MxN y NxP elementos,
